  ...
  sections: [
    {
      ...
      children: [
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: 'Capitalization Table for Tracking Equity Ownership', size: 24 }),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            ...
            new TextRun(
              'Use this template in Excel/Google Sheets or transfer to Carta/Pulley for professional cap table management.'
            ),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun('A '),
            new TextRun({ text: 'Capitalization Table (Cap Table)', bold: true }),
            new TextRun(' tracks who owns what percentage of your company.'),
          ],
        }),
        new Paragraph({ text: '' }),
        new Paragraph({
        ...
        new Table({
          ...
          rows: [
              ...
              children: [
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun({ text: 'Shareholder', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun({ text: 'Share Class', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun({ text: 'Shares Owned', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun({ text: '% Ownership', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('[Founder Name]')] })],
                }),
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('Common Stock')] })],
                }),
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun('10,000,000')],
                    }),
                  ],
                }),
                new TableCell({
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [
                    new Paragraph({
                      children: [new TextRun({ text: 'Total Outstanding', bold: true })],
                    }),
                  ],
                }),
                ...
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun({ text: '10,000,000', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun({ text: '100.00%', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
              ...
              children: [
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun({ text: 'Investor', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun({ text: 'Investment', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
              ...
              children: [
                ...
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.CENTER,
                      children: [new TextRun('10/27/2025')],
                    }),
                  ],
                }),
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('Unconverted')] })],
                }),
              ],
            }),
          ],
        ...
        new Table({
          ...
          rows: [
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('Founder')] })],
                }),
                ...
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun('$4,583,333')],
                    }),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('SAFE Investor')] })],
                }),
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('Series A Pref')] })],
                }),
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun('600,000')],
                    }),
                  ],
                }),
                new TableCell({
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('Series A Lead')] })],
                }),
                new TableCell({
                  children: [new Paragraph({ children: [new TextRun('Series A Pref')] })],
                }),
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun('1,400,000')],
                    }),
                  ],
                }),
                new TableCell({
              ...
              children: [
                ...
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun({ text: '12,000,000', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                ...
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun({ text: '$600,000', bold: true })],
                    }),
                  ],
                }),
                new TableCell({
                  children: [
                    new Paragraph({
                      alignment: AlignmentType.RIGHT,
                      children: [new TextRun({ text: '$5,500,000', bold: true })],
                    }),
                  ],
                }),
              ],
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'Dilution: ', bold: true }),
            new TextRun('Founder dilution: 100% → 83.33% (16.67% given up)'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Total capital raised: ', bold: true }),
            new TextRun('$600,000'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Post-money valuation: ', bold: true }),
            new TextRun('$5,500,000'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun('New Ownership % = (Old Shares) / (Old Shares + New Shares Issued)'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            ...
            new TextRun('Dilution from option pool hits founders, not investors'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            ...
            new TextRun('Excel/Google Sheets (free)'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Once you raise >$100K: ', bold: true }),
            new TextRun('Use Carta or Pulley'),
          ],
        }),
        new Paragraph({
          children: [new TextRun('• Carta: https://carta.com ($2K-$5K/year, industry standard)')],
        }),
        new Paragraph({
          children: [new TextRun('• Pulley: https://pulley.com ($500-$2K/year, simpler/cheaper)')],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [new TextRun("• Carta's cap table 101: https://carta.com/equity/equity-101/")],
        }),
        new Paragraph({
          children: [new TextRun('• YC cap table guide: https://www.ycombinator.com/library')],
        }),
