  ...
  sections: [
    {
      ...
      children: [
        ...
        new Paragraph({
          ...
          spacing: { before: 400 },
          children: [
            new TextRun({ text: 'Multi-Tenant Fund Accounting for HOAs', size: 36, bold: true }),
          ],
        }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
          spacing: { before: 800 },
          children: [
            new TextRun({ text: 'Eliminating $70K+ in annual accounting costs', size: 28 }),
          ],
        }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({ text: '90% Use Spreadsheets - ', bold: true }),
            new TextRun('Generic accounting software not designed for fund accounting'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: '20-40 Hours/Month on Bank Reconciliation - ', bold: true }),
            new TextRun('Manual, error-prone process'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: '$50K-$200K Lost Revenue Annually - ', bold: true }),
            new TextRun('Reactive delinquency tracking'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: '60-120 Hours for Audit Prep - ', bold: true }),
            new TextRun('Manual ledger reconstruction'),
          ],
        }),
        new Paragraph({ text: '', spacing: { before: 400 } }),
        new Paragraph({
          children: [
            ...
            new TextRun('Board liability, legal issues, expensive outsourced CPAs'),
          ],
        }),
        ...
        new Paragraph({
          children: [new TextRun('• Operating, Reserve, Special Assessment funds')],
        }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: '2. Bank Reconciliation (90%+ Auto-Match)', bold: true, size: 26 }),
          ],
        }),
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: 'TAM: 370,000 HOAs × $5,000/yr = $1.85B', size: 28, bold: true }),
          ],
        }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
          spacing: { before: 200 },
          children: [
            new TextRun({ text: 'SAM: 100,000 HOAs (50+ units) = $500M', size: 28, bold: true }),
          ],
        }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
        ...
        new Paragraph({
          children: [new TextRun('• No dominant player in HOA-specific fund accounting')],
        }),
        new Paragraph({
          children: [
            new TextRun(
        ...
        new Paragraph({
          children: [
            new TextRun({ text: '• Tier 1 (50-100 units): ', bold: true }),
            new TextRun('$400/mo → $4,800/year'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '• Tier 2 (100-250 units): ', bold: true }),
            new TextRun('$600/mo → $7,200/year'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '• Tier 3 (250-500 units): ', bold: true }),
            new TextRun('$800/mo → $9,600/year'),
          ],
        }),
        new Paragraph({ text: '', spacing: { before: 400 } }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun('• Current cost: $70K-$120K/year (outsourced CPA)')],
        }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'Year 1 (2026): ', bold: true }),
            new TextRun('$200K ARR, 40 customers, 3 headcount'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Year 2 (2027): ', bold: true }),
            new TextRun('$600K ARR, 100 customers, 5 headcount (200% growth)'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Year 3 (2028): ', bold: true }),
            new TextRun('$1.5M ARR, 225 customers, 8 headcount (150% growth)'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Year 4 (2029): ', bold: true }),
            new TextRun('$3.2M ARR, 450 customers, 12 headcount (113% growth)'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Year 5 (2030): ', bold: true }),
            new TextRun('$5.5M ARR, 780 customers, 18 headcount (Profitable!)'),
          ],
        }),
        new Paragraph({ text: '', spacing: { before: 400 } }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun('• Churn rate: 10-15% annually (high switching costs)')],
        }),
        new Paragraph({
          children: [new TextRun('• Sales cycle: 60-90 days (enterprise sales to boards)')],
        }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'AppFolio ($1.5B): ', bold: true }),
            new TextRun('Property mgmt (rentals), not for HOAs → We have HOA fund accounting'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Buildium: ', bold: true }),
            new TextRun('Generic accounting → We have fund separation'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'IronLedger (YC): ', bold: true }),
            new TextRun("General properties → We're HOA-specific"),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Palomma (YC): ', bold: true }),
            new TextRun("Leasing/sales focus → We're compliance"),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Spreadsheets (90%): ', bold: true }),
            new TextRun("Error-prone → We're automated"),
          ],
        }),
        new Paragraph({ text: '', spacing: { before: 400 } }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun('✓ Fund accounting expertise: Operating, Reserve, Special Assessment'),
          ],
        }),
        new Paragraph({
          children: [new TextRun('✓ Zero error tolerance: Immutable ledger, event sourcing')],
        }),
        new Paragraph({
          children: [new TextRun('✓ Multi-tenant architecture: Schema-per-tenant data isolation')],
        }),
        new Paragraph({
          children: [new TextRun('✓ 2-3 year head start: Complex domain, high barrier to entry')],
        }),
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: 'Round: Pre-Seed / Friends & Family', size: 26, bold: true }),
          ],
        }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: '$1.5M-$2M valuation cap, 20% discount', size: 26, bold: true }),
          ],
        }),
        new Paragraph({ text: '', spacing: { before: 600 } }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Use of Funds (12-Month Runway):', bold: true, size: 24 }),
          ],
        }),
        ...
        new Paragraph({
          children: [new TextRun({ text: '✓ 3 pilot customers onboarded', size: 24 })],
        }),
        new Paragraph({
          children: [
            new TextRun({
              text: '✓ Core features: fund accounting, bank reconciliation, basic AR',
              size: 24,
            }),
          ],
        }),
        ...
        new Paragraph({
          children: [new TextRun({ text: '✓ 10 paying customers ($50K ARR)', size: 24 })],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '✓ Product refinements based on pilot feedback', size: 24 }),
          ],
        }),
        new Paragraph({ text: '', spacing: { before: 400 } }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun({ text: '✓ 25 paying customers ($120K ARR)', size: 24 })],
        }),
        new Paragraph({
          children: [new TextRun({ text: '✓ First partnership signed', size: 24 })],
        }),
        new Paragraph({ text: '', spacing: { before: 400 } }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun({ text: '✓ 40 paying customers ($200K ARR)', size: 24 })],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '✓ Apply to Y Combinator (Winter 2026 batch)', size: 24 }),
          ],
        }),
        ...
        new Paragraph({
          children: [
            new TextRun('1. AppFolio ($1.5B market cap) - Add HOA fund accounting to portfolio'),
          ],
        }),
        new Paragraph({
          children: [new TextRun('2. Buildium/RealPage - Expand property management suite')],
        }),
        new Paragraph({
          children: [new TextRun('3. Yardi (largest property management software)')],
        }),
        new Paragraph({
          children: [new TextRun('4. Intuit (QuickBooks) - Enter vertical accounting market')],
        }),
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: 'Target Exit: $50M-$150M in 5-7 years', bold: true, size: 30 }),
          ],
        }),
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: "Let's Build the Future of HOA Accounting Together",
              size: 40,
              bold: true,
            }),
          ],
