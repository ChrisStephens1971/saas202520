      ...
      children: [
        ...
        new Paragraph({
          children: [
            ...
            new TextRun('Be prepared for investor due diligence by having these documents ready'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'Due diligence', bold: true }),
            new TextRun(
              ' is the process where investors verify your claims and assess risks before investing.'
            ),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun('• Friends & Family: Minimal due diligence (1-2 days)')],
        }),
        ...
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun('IP assignment from contractors (if hired any developers/designers)'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun('Competitive analysis (who are competitors, how you differentiate)'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
        ...
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun('Customer references (HOA board members willing to vouch for you)'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun('Industry references (CPAs, property managers who know the space)'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun('Personal references (professional contacts who can vouch for founder)'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'Total Prep Time: ', bold: true }),
            new TextRun('2-4 weeks (can do in parallel with fundraising)'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [new TextRun('• Carta: https://carta.com (includes data room)')],
        }),
        ...
        new Paragraph({
          children: [new TextRun('• Clerky: https://www.clerky.com (incorporation, SAFEs)')],
        }),
        new Paragraph({
          children: [new TextRun('• Gust Launch: https://gust.com/launch (incorporation + legal)')],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: 'REMEMBER: Investors expect gaps at pre-revenue stage. Be honest, organized, and responsive.',
              italics: true,
              bold: true,
              size: 24,
            }),
