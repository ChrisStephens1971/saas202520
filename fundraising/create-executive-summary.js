  ...
  sections: [
    {
      ...
      children: [
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: 'Multi-Tenant HOA Accounting System', size: 28, bold: true }),
          ],
        }),
        new Paragraph({ text: '' }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "We're building the first multi-tenant fund accounting platform designed specifically for Homeowners Associations (HOAs) ",
              bold: true,
            }),
            new TextRun(
              'that eliminates $70K+ in annual accounting costs while ensuring zero tolerance for financial errors.'
            ),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          ...
          children: [
            ...
            new TextRun('or generic accounting software not designed for fund accounting'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Manual bank reconciliation ', bold: true }),
            new TextRun('takes 20-40 hours/month per property'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Delinquency tracking ', bold: true }),
            new TextRun('is reactive, costing HOAs $50K-$200K annually in lost revenue'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Audit preparation ', bold: true }),
            new TextRun('requires 60-120 hours of manual ledger reconstruction'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Zero tolerance for errors ', bold: true }),
            new TextRun('- financial mistakes can result in board liability and legal issues'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun('Separate accounting for Operating, Reserve, and Special Assessment funds'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
              ...
              children: [
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      children: [
                        new TextRun({ text: 'Total Addressable Market (TAM)', bold: true }),
                      ],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      children: [
                        new TextRun('370,000 HOAs × $5,000/yr = '),
                        new TextRun({ text: '$1.85 billion', bold: true }),
                      ],
                    }),
                  ],
                }),
              ...
              children: [
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      children: [
                        new TextRun({ text: 'Serviceable Available Market (SAM)', bold: true }),
                      ],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      children: [
                        new TextRun('100,000 HOAs (50+ units) = '),
                        new TextRun({ text: '$500 million', bold: true }),
                      ],
                    }),
                  ],
                }),
              ...
              children: [
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      children: [
                        new TextRun({ text: 'Serviceable Obtainable Market (SOM)', bold: true }),
                      ],
                    }),
                  ],
                }),
                new TableCell({
                  ...
                  children: [
                    new Paragraph({
                      children: [
                        new TextRun('1% in 5 years = '),
                        new TextRun({ text: '$5 million ARR', bold: true }),
                      ],
                    }),
                  ],
                }),
        ...
        new Paragraph({
          ...
          children: [
            ...
            new TextRun('$400/month → $4,800/year'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            ...
            new TextRun('$600/month → $7,200/year'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            ...
            new TextRun('$800/month → $9,600/year'),
          ],
        }),
        new Paragraph({ text: '' }),
        new Paragraph({
        ...
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Current cost: ', bold: true }),
            new TextRun('$70K-$120K/year (outsourced CPA or internal bookkeeper)'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Our price: ', bold: true }),
            new TextRun('$4,800-$9,600/year'),
          ],
        }),
        new Paragraph({
          numbering: { reference: 'bullet-list', level: 0 },
          children: [
            new TextRun({ text: 'Customer savings: ', bold: true }),
            new TextRun('$60K-$110K/year (85-92% cost reduction)'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'Round: ', bold: true }),
            new TextRun('Pre-Seed / Friends & Family'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Amount: ', bold: true }),
            new TextRun('$100,000 - $500,000'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Structure: ', bold: true }),
            new TextRun('SAFE note with $1.5M - $2M valuation cap, 20% discount'),
          ],
        }),
        new Paragraph({ text: '' }),
        new Paragraph({
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: 'This is a confidential document intended solely for potential investors.',
              italics: true,
              size: 20,
            }),
          ],
