  ...
  sections: [
    {
      ...
      children: [
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: 'Multi-Tenant HOA Accounting System (saas202509)', size: 20 }),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            ...
            new TextRun(
              'HOAs spend $70K-$120K annually on fragmented accounting systems that require manual bank reconciliation (20-40 hours/month) and lack proper fund accounting. 90% use spreadsheets or generic software not designed for HOA compliance needs.'
            ),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun({ text: '• TAM: ', bold: true }),
            new TextRun('370,000 HOAs in the US × $5,000/year = $1.85 billion'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '• SAM: ', bold: true }),
            new TextRun('100,000 HOAs (50+ units) = $500 million'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '• SOM: ', bold: true }),
            new TextRun('1% in 5 years = $5 million ARR'),
          ],
        }),
        new Paragraph({
          children: [
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun('HOAs with 50-500 units, $500K-$5M annual budgets. Two segments:'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '1. Self-managed HOAs (40%)', bold: true }),
            new TextRun(' - Board members handle accounting themselves, highest pain'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: '2. Small property managers (35%)', bold: true }),
            new TextRun(' - Manage 1-10 HOAs, need specialized software'),
          ],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Not targeting: ', bold: true }),
            new TextRun(
              'Large property management companies (already use enterprise software like Yardi).'
            ),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun('They serve property managers, not HOAs directly. Key differences:'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun('• Weakness: No separation of Operating/Reserve/Special Assessment funds'),
          ],
          indent: { left: 360 },
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun('• Accounting: Built-in fund separation, double-entry bookkeeping'),
          ],
          indent: { left: 360 },
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun({ text: "Innovator's Dilemma: ", bold: true }),
            new TextRun(
              "They won't rebuild their architecture for HOAs (would cannibalize existing product). We have 2-3 year head start."
            ),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun('Both are general property accounting/management AI platforms:'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun('• Focus: AI accounting agents for property accounting (general)'),
          ],
          indent: { left: 360 },
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun('• Focus: AI agents for property management (leasing, sales, collections)'),
          ],
          indent: { left: 360 },
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun('• Higher barrier to entry: Complex domain requires years to master'),
          ],
          indent: { left: 360 },
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Market Validation: ', bold: true }),
            new TextRun(
              'YC funding these competitors proves investor appetite for property accounting innovation.'
            ),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun('Pre-revenue, MVP in development. However:'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun('• 90% cited bank reconciliation as #1 pain point')],
        }),
        new Paragraph({
          children: [
            new TextRun('• Identified willingness to pay ($70K → $5K/year = 93% cost reduction)'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun('• Pilot program agreements (targeting 3-5 HOAs)')],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun({ text: '$100K-$500K', bold: true }),
            new TextRun(' on a SAFE with '),
            new TextRun({ text: '$1.5M-$2M valuation cap', bold: true }),
            new TextRun(' and '),
            new TextRun({ text: '20% discount', bold: true }),
            new TextRun('.'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun({ text: 'Milestones (12 months):', bold: true }),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            ...
            new TextRun('Prove product-market fit, position for Series A at $5M-$8M valuation.'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun('Pre-revenue, so using '),
            new TextRun({ text: 'SAFE with $1.5M-$2M valuation cap', bold: true }),
            new TextRun('.'),
          ],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [new TextRun('• Below average pre-seed ($5.7M per Pitchbook 2025)')],
        }),
        new Paragraph({ children: [new TextRun('• Fair for solo founder, pre-revenue')] }),
        new Paragraph({
          children: [new TextRun('• YC-backed competitors (IronLedger, Palomma) at $10M+ post-YC')],
        }),
        new Paragraph({
          children: [new TextRun("• We're asking 50-80% less to account for earlier stage")],
        }),
        new Paragraph({
          children: [
            new TextRun({ text: 'Negotiable', italics: true }),
            new TextRun(' based on investor feedback and market conditions.'),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: 'A: ', bold: true }),
            new TextRun({ text: 'Acquisition in 5-7 years', bold: true }),
        ...
        new Paragraph({
          children: [new TextRun('5. Private Equity - Roll-up play (consolidate HOA software)')],
        }),
        new Paragraph({
        ...
        new Paragraph({
          children: [
            new TextRun({ text: "I'm building to sell, not to run forever.", italics: true }),
          ],
        }),
        new Paragraph({ text: '' }),
        ...
        new Paragraph({
          children: [
            new TextRun('1. Large, underserved market: $500M SAM, 90% using spreadsheets'),
          ],
        }),
        new Paragraph({
          children: [
        ...
        new Paragraph({
          children: [
            new TextRun('5. Clear exit path: Acquisition by AppFolio, Buildium, Yardi, or PE firm'),
          ],
        }),
        new Paragraph({ text: '' }),
        new Paragraph({
          children: [
            new TextRun({
              text: 'This is a once-in-a-cycle opportunity to get in early on a category-defining company.',
              bold: true,
              italics: true,
            }),
          ],
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: "Ready to invest? Let's schedule a follow-up call and get the paperwork started.",
              size: 24,
              bold: true,
            }),
          ],
