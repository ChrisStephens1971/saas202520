...
- **Type**: [SaaS Application / API / Library / CLI Tool / etc.]
- **Architecture**: [Monorepo / Microservices / Monolith]
- **Tech Stack**: [e.g., Next.js 14, Express, PostgreSQL, Redis]
- **Purpose**: [Brief 1-sentence description of what this project does]
