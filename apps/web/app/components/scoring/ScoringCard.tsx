  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-4">
        <div className="text-center mb-2 text-gray-600 text-sm">{formatScore(score, raceTo)}</div>

        <div className="grid grid-cols-2 gap-4">
          {/* Player A */}
          <div className="text-center">
            <div className="text-lg font-semibold text-gray-700 mb-2">{playerAName}</div>
            <div className="text-6xl font-bold text-blue-600 mb-4">{score.playerA}</div>
            <button
          ...
          {/* Player B */}
          <div className="text-center">
            <div className="text-lg font-semibold text-gray-700 mb-2">{playerBName}</div>
            <div className="text-6xl font-bold text-green-600 mb-4">{score.playerB}</div>
            <button
